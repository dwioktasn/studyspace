...
export default function Sidebar() {
  ...
  const links = [
    ...
    { name: 'Pomodoro', href: '/app/pomodoro', icon: (
    ...
    { name: 'Goals', href: '/app/goals', icon: (
    ...
    { name: 'Statistics', href: '/app/statistics', icon: (
    ...
    { name: 'Schedule', href: '/app/schedule', icon: (
    ...
    <aside className="sidebar">
      <div className="sidebar-logo">
        ...
        <div className="logo-text">
          ...
          <span className="logo-subtitle">COZY PRODUCTIVITY</span>
        </div>
      </div>
      ...
      <div className="sidebar-bottom">
        <div className="streak-card">
          <p className="streak-quote">"Small steps, every day."</p>
          <div className="streak-count">Streak: 12 days 🔥</div>
        </div>
      </div>
    </aside>
  );
